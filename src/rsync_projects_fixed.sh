...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.Interpreter/ ./Unity/MoonSharp/Assets/Plugins/MoonSharp/Interpreter/

echo ... Unity - vscode debugger...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.VsCodeDebugger/ ./Unity/MoonSharp/Assets/Plugins/MoonSharp/Debugger/

echo ... Unity - unit tests...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.Interpreter.Tests/ ./Unity/MoonSharp/Assets/Tests
...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.Interpreter/ ./MoonSharp.Interpreter/_Projects/MoonSharp.Interpreter.netcore/src/

echo ... .NET Core - vscode debugger...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.VsCodeDebugger/ ./MoonSharp.VsCodeDebugger/_Projects/MoonSharp.VsCodeDebugger.netcore/src

echo ... .NET Core - unit tests...
rsync -a --prune-empty-dirs --exclude 'AssemblyInfo.cs' --include '*/' --include '*.cs' --exclude '*' ./MoonSharp.Interpreter.Tests/ ./TestRunners/DotNetCoreTestRunner/src